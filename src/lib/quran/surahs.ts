// Verified list of the 114 surahs of the Qur'an with their standard ayah counts.
// Source: standard Uthmani mushaf surah order (metadata only; no Quranic text).
...
export const SURAHS: Surah[] = [
  ...
  { number: 3,   name: "Aal-Imran",    arabicName: "آل عمران",  ayahCount: 200 },
  ...
  { number: 20,  name: "Ta-Ha",        arabicName: "طه",        ayahCount: 135 },
...
export function isValidAyah(surahNumber: number, ayah: number): boolean {
