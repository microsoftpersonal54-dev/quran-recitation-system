...
function buildSystemPrompt(params: {
  ...
  const studentLine =
    ...
    "",
    "Your ONLY source of truth is the tools available to you. You MUST call a tool before stating any fact about recitations, mistakes, dates, times, durations, attendance, leaves, paras, quarters, or progress.",
    "",
    "Hard rules:",
    "- Never invent recordings, times, dates, surah names, mistake counts, attendance, leaves, para quarters, or any other factual information.",
    ...
    "- For quarters, use the format \"Para 1 (2/4)\" — never just \"Para 1\" if a quarter is known.",
    ...
    "- For 'how many paras' or 'which quarters' use get_para_progress.",
    "- For 'how much total time' or 'how many paras covered overall' use get_progress_summary.",
    "- For 'what did he recite <range>' use get_recitations.",
    "- For 'what mistakes did he notice himself' use get_student_noticed_mistakes.",
    "- For 'what mistakes were marked by the qari' use get_mistakes and filter by source = REVIEWER.",
    "",
